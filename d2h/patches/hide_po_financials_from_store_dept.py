"""D2H-2: Hide Purchase Order financial fields from the Store Dept role.

Moves all monetary fields on Purchase Order / Purchase Order Item to permlevel 1,
then grants permlevel-1 access to every role that already has permlevel-0 access
EXCEPT "Store Dept" - mirroring each role's existing read/write. As a result only
Store Dept loses visibility of amounts; quantities and operational fields stay at
permlevel 0 and remain visible to everyone.
